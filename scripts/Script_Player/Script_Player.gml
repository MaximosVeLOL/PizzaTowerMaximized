...
case Moveset.PreETB:
			switch(state) {
				...
				case "jump":
					...
					if(GetInput("jump", 2) && velocity.y < 0) velocity.y /= 2;
				...
				break;
						...
						case "mach2":
							...
							if(PLAYER_GROUNDED) {
								...
								if(GetInput("jump", 1)) velocity.y = -9;
								if(!GetInput("jump", 0) && velocity.y < 0) velocity.y /= 2;
							}
						...
						case "mach3":
							...
							if(PLAYER_GROUNDED) {
								...
								if(GetInput("jump", 0)) velocity.y = -9;
