...
screens = [
	new CreateScreen("SETTINGS", ["AUDIO", "VIDEO", "GAMEPLAY", "BACK"], [function(){setScreen(1)}, function(){setScreen(2)}, function(){setScreen(4)}, function(){if(room != Room_MainMenu) instance_activate_object(o_UI_PauseMenu);else instance_activate_object(o_UI_MainMenu); instance_destroy(); SaveSettings(); ApplySettings();}]),
	...
	new CreateScreen("GAMEPLAY", ["DEBUG ENABLED", "PLAYER SETTINGS", "KEY BINDS", "BACK"], [0, function(){setScreen(5)}, function(){instance_create_depth(0,0,0,o_UI_KeyBinds);instance_deactivate_object(self);}, function(){setScreen(0)}], [1,0,0,0], ["debug"]),
