...
screens = [
	...
	new CreateScreen("PLAYER", ["SET MOVESET", "MOVESET SETTINGS", "WATER INTERACTION", "BACK"], [function(){setScreen(6)}, function(){setScreen(7)}, 0, function(){setScreen(0)}], [0, 0, 1, 0], [0, 0, 0, "waterInteraction", 0]),
