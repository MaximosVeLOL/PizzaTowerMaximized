...
buffer_seek(networkSettings.buffer, buffer_seek_start, 0);
buffer_write(networkSettings.buffer, buffer_u16, x);
buffer_write(networkSettings.buffer, buffer_u16, y);
buffer_write(networkSettings.buffer, buffer_u16, sprite_index);
buffer_write(networkSettings.buffer, buffer_u16, image_index);
buffer_write(networkSettings.buffer, buffer_u16, xscale);
network_send(networkSettings.socket, networkSettings.buffer, buffer_tell(networkSettings.buffer));