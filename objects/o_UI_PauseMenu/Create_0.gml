...
screens = [
	...
	new CreateScreen("QUIT OPTIONS", ["QUIT TO DEMO ROOM", "QUIT TO DESKTOP", "BACK"], [function(){instance_activate_all();o_GameManager.endLevel(false, true)  }, function(){game_end();}]),
];
