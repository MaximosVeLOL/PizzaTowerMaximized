...
screens = [
	...
	new CreateScreen("QUIT OPTIONS", ["QUIT TO DEMO ROOM", "QUIT TO DESKTOP", "QUIT TO MENU", "BACK"], [function(){if(room == Room_DemoRoom){return;}instance_activate_all();o_GameManager.endLevel(false, true)  }, function(){game_end();}, function(){instance_activate_all();o_GameManager.level.demo = true; o_GameManager.goToHub();}, function(){setScreen(0);}]),
];
