if(global.settings.gameplay.fpsSave = FPSSaveMode.UselessRemover || array_length(logs) == 0) return;
...
//If you want to have it compressed, but that doesn't make sense.settings..
