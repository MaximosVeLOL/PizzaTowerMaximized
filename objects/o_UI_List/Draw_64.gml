...
draw_sprite(spr_player_idle, -1, 480 - (string_length(screens[currentScreen].optionText[currentOption]) * 12), (200 + (currentOption * 20)))
for(var i = 0 ; i < array_length(screens[currentScreen].optionText);i++) {
	draw_text(480, 200 + (i * 20), string_upper(screens[currentScreen].optionText[i]));
